...
fun main(args: Array<String>) {
    println("----16.1----")
    val a: IntArray = intArrayOf(1000, 1200, 1500, 1000, 2500)
    ...
    val a4: IntArray = intArrayOf(
        1000, 1200, 1500, 1000, 2400, 3000, 3800)
    ...
    println("----16.9----")
    val h9 = arrayOf("こんにちは","Kotlin","どうぞ","よろしく","お願い申し上げ",)
    for (x in h9) println("String型の配列の値${x}")
